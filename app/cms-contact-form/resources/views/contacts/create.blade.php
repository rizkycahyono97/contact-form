...
@section('content')
    ...
    <form 
        ...
        method="POST" 
        class="mx-w-lg mx-auto bg-white p-6 rounded shadow-md"
        onsubmit="return confirm('Are sure to create this contact');"
    >
        @csrf
        <div class="mb-4">
            <label for="block mb-2 font-semi-bold">Name</label>
        ...
        <div class="flex justify-between">
            <a href="{{ route('contacts.index') }}" class="bg-gray-500 text-white px-4 oy-2 rounded hover:bg-gray-600">Cancel</a>
